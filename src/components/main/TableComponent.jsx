...
const JassGame = (props) => {
  ...
  useEffect(() => {
    ...
    socket.on('updateGame', (updatedGameState) => {
      ...
      setTrumpSuit(updatedGameState.trumpSuit);
  ...
  const playCard = (index) => {
    ...
    socket.emit('playCard', { playerIndex: selectedPlayer, card });
